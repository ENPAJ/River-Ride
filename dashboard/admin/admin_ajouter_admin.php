...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // Code pour traiter les données soumises depuis le formulaire de création de admin
    if (isset($_POST['nom'], $_POST['prenom'], $_POST['email'], $_POST['mot_de_passe'])) {
        ...
        $mot_de_passe = password_hash($_POST['mot_de_passe'], PASSWORD_DEFAULT);
            ...
            try {
                // Code pour insérer les données du admin dans la base de données
                ...
                $message = "Le admin a été créé avec succès";
                $alertClass = "alert alert-success"; // Classe de l'alerte de succès

            } catch (PDOException $e) {
                // Gérer les erreurs PDO
                // ...
                $message = "Une erreur est survenue lors de la création du admin : " . $e->getMessage();
                    ...
                    <div class="card mb-4">
                        <div class="card-body px-0 pt-0 pb-2">
                            <div class="table-responsive p-0">
                                <div>
                                <h3 style="color: black;">Créer admin</h3>
                                    <button type="button" class="btn btn-warning" style="background:orange; color:black;">
                                        <a href="admin_afficher_admin.php">Liste des admins</a>
                                    </button>
                                </div>
