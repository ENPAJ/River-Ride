                                    ...
                                    <table class="table mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="align-middle">
                                                ...
                                                <td>
                                                    <button type="submit" class="btn btn-info btn-lg"><a href="admin_modifier_packs.php?id=<?php echo $packs['pack_id']; ?>">Modifier</a></button>
                                                    <button type="button" class="btn btn-warning btn-lg">
                                                        <a href="admin_supprimer_packs.php?id=<?php echo $packs['pack_id']; ?>" class="btn-supprimer" onclick="confirmerSuppression(this)">Supprimer</a>
                                                    </button>
                                                </td>
                                            </tr>
                                            <?php endforeach; ?>
